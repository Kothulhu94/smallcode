 ...
 *
 * Return shape:
 *   { ok: true,  rootPath: '/absolute/path' }   — workspace active + rootPath set
 *   { ok: false, reason: 'no_active_workspace' } — no workspace is active
 *   { ok: false, reason: 'no_root_path' }        — workspace active but rootPath not set
 *   { ok: false, reason: 'invalid_root_path', detail: '…' } — rootPath stored but invalid
 *
