...
For issues that could affect other users (e.g., a dependency vulnerability), we prefer responsible disclosure — reach out before posting publicly so we can prepare a fix.
